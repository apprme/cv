...
\usepackage{geometry}
\geometry{a4paper, top=15mm, bottom=15mm, left=20mm, right=20mm}
...
\begin{document}
    ...
    \centering{
        ...
        \Large{\textsc{Software Engineer}}\bigskip\par
    }
    ...
    \begin{tabular}{rl}
        ...
        \textsc{Address} & Bavaria, Germany                                               \\
    \end{tabular}\bigskip

    \section{Work Experience}
    \begin{tabular}{r|p{13cm}}
        \experience{Feb 2022 --- Present}{Reddit Germany (f.k.a. Mobile Motion) GmbH, Remote \href{https://redditinc.com}{redditinc.com}}{Software Developer} {
            Contributing to the efforts of the Internationalization organization at Reddit, aiming to increase the number of users in emerging markets. Improving
            user experience via numerous performance optimizations, simplifying user onboarding through enhancements to the signup flow
            (phone number authentication), boosting user retention and engagement via various gamification features (streaks, achievements) and
            WhatsApp notifications, and increasing content consumption through new discovery surfaces (automatic live feeds covering soccer,
            cricket, and basketball matches; revamp of "Discover" tab of mobile apps with recommendations of trending and relevant content, and others).

            Reddit builds most of its backend systems using modern versions of Golang, and deploys them to Kubernetes clusters across multiple geo regions
            and clouds.
        }
        \experience{Sep 2021 --- Feb 2022}{FlixMobility Tech GmbH, Munich \href{https://www.flixbus.de/unternehmen/ueber-flixbus}{flixbus.de}}{Software Developer} {
            As part of Ancillaries team, developed a backend system that manages bulky luggage capacity of FlixBus buses.

            ACS (Ancillaries Capacity System) was one of the early attempts within Flix to migrate from legacy PHP stack to kotlin and akka.
        }
        \experience{Mar 2013 --- Sep 2021}{Delightex GmbH, Munich \href{https://delightex.com}{delightex.com}}{Software Developer} {
